...
import ScheduleConversationButton from 'dashboard/modules/disparador/components/ScheduleConversationButton.vue';
...
<template>
  ...
  >
    ...
    >
      ...
      <ScheduleConversationButton :conversation="currentChat" />
